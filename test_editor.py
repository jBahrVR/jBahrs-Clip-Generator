...
class TestEditorExtractAudioHidden(unittest.TestCase):
    ...
    def test_extract_audio_hidden_success_linux(self, mock_subprocess_run):
        ...
        with unittest.mock.patch('os.name', 'posix'):
            ...
            mock_subprocess_run.assert_called_once_with(expected_cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, startupinfo=None, timeout=600)
    ...
    @unittest.mock.patch('subprocess.run')
    def test_extract_audio_hidden_success_windows(self, mock_subprocess_run):
        ...
        with unittest.mock.patch('os.name', 'nt'):
            ...
            with unittest.mock.patch.object(subprocess, 'STARTUPINFO', DummyStartupInfo, create=True), \
                ...
                # Retrieve the arguments passed to subprocess.run
    ...
    @unittest.mock.patch('subprocess.run')
    def test_extract_audio_hidden_failure(self, mock_subprocess_run):
